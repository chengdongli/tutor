...
public class MyGraphicalEditor extends GraphicalEditorWithPalette {
	...
	protected class OutlinePage extends ContentOutlinePage{
		...
		public void init(IPageSite pageSite) {
			...
			bars.setGlobalActionHandler(ActionFactory.RENAME.getId(), getActionRegistry().getAction(ActionFactory.RENAME.getId()));
	...
	protected PaletteRoot getPaletteRoot() {
		...
		PaletteGroup instGroup = new PaletteGroup("Creation elemnts");
		root.add(instGroup);
		...
		instGroup.add(new CombinedTemplateCreationEntry("Employe", "Creation an employe model",
		...
		// cad lors de : la premiere ouverture de la palette ou lorsqu'un element de la palette rend la main
